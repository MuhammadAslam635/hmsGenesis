...
rules(['firstname' => 'required','lastname' => 'required', 'email' => 'required|email|unique:users', 'password' => 'required|min:8|same:passwordConfirmation']);
name('register');
            ...
            <div class="px-10 py-0 sm:py-8 sm:shadow-sm sm:bg-white dark:sm:bg-gray-950/50 dark:border-gray-200/10 sm:border sm:rounded-lg border-gray-200/60">
                @volt('auth.register')
                    <form wire:submit="register" class="space-y-6">
                        <x-ui.input label="First Name" type="text" id="firstname" name="firstname" wire:model="firstname" />
                        <x-ui.input label="Last Name" type="text" id="lastname" name="lastname" wire:model="lastname" />
